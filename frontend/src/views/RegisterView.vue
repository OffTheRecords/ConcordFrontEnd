      ...
      <form class="text-left bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 mt-40 border">
        ...
        <!-- @csrf -->
          ...
          <div class="flex items-center justify-between">
            <button class="px-4 py-2 rounded text-white inline-block shadow-lg bg-[#facc15] hover:bg-[#eab308] focus:bg-[#a16207]" type="button" v-on:click="submitForm(email, username, password)" >Register</button>
          </div>
      </form>
